...
export class DoctorsComponent implements OnInit {
  ...
  constructor(private _DataService: DataService, private _AuthService: AuthService, private _FormBuilder:FormBuilder, private toastr: ToastrService, private router: Router) {
    // Declare FilterForm
  ...
  getFilteredDoctors() {
    ...
    this._DataService._lang.subscribe({
      next: (lang) => {
        ...
        this.doctorsSubscription = this._DataService.getFilteredDoctors(this.filterForm.value,this.lang, this.page).subscribe({
          next: (doctors) => {
