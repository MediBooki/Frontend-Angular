...
/*=============================================( Initialization Methods )=============================================*/
  constructor(private _DataService:DataService, private _AuthService: AuthService , private _TranslateService:TranslateService,  private router: Router, private toastr: ToastrService) { }
  ...
  getFormData(){
    ...
    if(this.joinusForm.valid){
      if(this.joinusForm.controls.re_password.value == this.joinusForm.controls.password.value){
        ...
        this._DataService.doctorJoinus(this.formdata).subscribe({
          next: (response) => {
