...
export class PatientProfileComponent implements OnInit {
  ...
  constructor(private _AuthService: AuthService, private _DataService:DataService,  private toastr: ToastrService ,  private router: Router,private _cartservice : CartService) { }
  ...
  ngOnInit(): void {
    ...
    this._DataService.isreview.subscribe(
